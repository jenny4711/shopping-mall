...
const goToAll=(cate)=>{
  ...
  return (
    ...
    <>
      <div onClick={()=>goToAll('woman')} className="category-title" > View Woman</div>
    <Slider  {...settings} className="card" >
   

      {
        showWoman.map((item,idx)=>(
          <EachCard img={item.image} id={item._id} name={item.name} price={item.price} showPrice={showPrice} />
    ...
    <div onClick={()=>goToAll('men')} className="category-title" > View Man</div>
    <Slider  {...settings}className="card" >
      {
    ...
    <div onClick={()=>goToAll('kids')} className="category-title" > View Kids</div>
    <Slider  {...settings}className="card" >
      {
